...
class Su_Vote {
	...
	function __construct() {
		...
		add_action( 'mn_ajax_su_vote',  array( __CLASS__, 'vote' ) );
	}
	...
	public static function register() {
		mn_register_style( 'su-vote', plugins_url( 'assets/css/vote.css', SU_PLUGIN_FILE ), false, SU_PLUGIN_VERSION, 'all' );
		mn_register_script( 'su-vote', plugins_url( 'assets/js/vote.js', SU_PLUGIN_FILE ), array( 'jquery' ), SU_PLUGIN_VERSION, true );
	}

	public static function enqueue() {
		mn_enqueue_style( 'su-vote' );
		mn_enqueue_script( 'su-vote' );
	}
...
?>
		<div class="su-vote" style="display:none">
			<div class="su-vote-wrap">
				<div class="su-vote-gravatar"><a href="http://profiles.mtaandao.org/gn_themes" target="_blank"><img src="http://www.gravatar.com/avatar/54fda46c150e45d18d105b9185017aea.png" alt="<?php _e( 'Vladimir Anokhin', 'shortcodes-ultimate' ); ?>" width="50" height="50"></a></div>
				<div class="su-vote-message">
					<p><?php _e( 'Hello, my name is Vladimir Anokhin, and I am developer of plugin <b>Shortcodes Ultimate</b>.<br>If you like this plugin, please write a few words about it at the mtaandao.org or twitter. It will help other people find this useful plugin more quickly.<br><b>Thank you!</b>', 'shortcodes-ultimate' ); ?></p>
					<p>
						<a href="<?php echo admin_url( 'admin-ajax.php' ); ?>?action=su_vote&amp;vote=yes" class="su-vote-action button button-small button-primary" data-action="http://mtaandao.org/support/view/plugin-reviews/shortcodes-ultimate?rate=5#postform"><?php _e( 'Rate plugin', 'shortcodes-ultimate' ); ?></a>
						<a href="<?php echo admin_url( 'admin-ajax.php' ); ?>?action=su_vote&amp;vote=tweet" class="su-vote-action button button-small" data-action="http://twitter.com/share?url=http://bit.ly/1blZb7u&amp;text=<?php echo urlencode( __( 'Shortcodes Ultimate - must have Mtaandao plugin #shortcodesultimate', 'shortcodes-ultimate' ) ); ?>"><?php _e( 'Tweet', 'shortcodes-ultimate' ); ?></a>
