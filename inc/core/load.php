...
class Shortcodes_Ultimate {
	...
	public static function init() {
		...
		__( 'Supercharge your Mtaandao theme with mega pack of shortcodes', 'shortcodes-ultimate' );
	...
	public static function meta_links( $links, $file ) {
		...
		if ( $file === plugin_basename( SU_PLUGIN_FILE ) ) {
			...
			$links[] = '<a href="http://mtaandao.org/support/plugin/shortcodes-ultimate/" target="_blank">' . __( 'Support forum', 'shortcodes-ultimate' ) . '</a>';
			$links[] = '<a href="http://mtaandao.org/extend/plugins/shortcodes-ultimate/changelog/" target="_blank">' . __( 'Changelog', 'shortcodes-ultimate' ) . '</a>';
		}
		return $links;
	}
}
