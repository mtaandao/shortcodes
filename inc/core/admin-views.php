...
<div id="su-about-screen">
	<h1><?php _e( 'Welcome to Shortcodes Ultimate', 'shortcodes-ultimate' ); ?> <small><?php _e( 'A real swiss army knife for Mtaandao', 'shortcodes-ultimate' ); ?></small></h1>
	<div class="sunrise-inline-menu">
		...
		<a href="http://mtaandao.org/support/plugin/shortcodes-ultimate/" target="_blank"><?php _e( 'Support forum', 'shortcodes-ultimate' ); ?></a>
		<a href="http://mtaandao.org/extend/plugins/shortcodes-ultimate/changelog/" target="_blank"><?php _e( 'Changelog', 'shortcodes-ultimate' ); ?></a>
	...
	<div class="su-clearfix">
		...
		<div class="su-about-column">
			...
			<p><?php _e( '<strong>Shortcode</strong> is a Mtaandao-specific code that lets you do nifty things with very little effort.', 'shortcodes-ultimate' ); ?></p>
...
<div id="su-custom-css-screen">
	...
	public static function examples( $field, $config ) {
		...
		$nonce = '<input id="su_examples_nonce" type="hidden" name="su_examples_nonce" value="' . mn_create_nonce( 'su_examples_nonce' ) . '" />';
	...
	public static function addons( $field, $config ) {
		...
		$output[] = '</div>';
		if ( count( $plugins ) ) {
			$output[] = '<h2>' . __( 'Other Mtaandao Plugins', 'shortcodes-ultimate' ) . '</h2>';
			$output[] = '<div class="su-addons-loop su-clearfix">';
