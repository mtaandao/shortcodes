jQuery(document).ready(function($) {
			...
			success: function(data) {
				...
				$('.su-generator-isp').each(function() {
					...
					$add_media.click(function(e) {
						...
						frame = mn.media.frames.su_media_frame_1 = mn.media({
				...
				$('.su-generator-upload-button').each(function() {
					...
					$button.on('click', function(e) {
						...
						// Create MN media frame.
						file = mn.media.frames.su_media_frame_2 = mn.media({
	...
	$('#su-generator').on('click', '.su-generator-insert', function(e) {
		...
		window.su_mnActiveEditor = window.mnActiveEditor;
		// Set new active editor
		window.mnActiveEditor = window.su_generator_target;
		// Insert shortcode
		window.mn.media.editor.insert(shortcode);
		// Restore previous editor
		window.mnActiveEditor = window.su_mnActiveEditor;
		// Check for target content editor
		// if (typeof window.su_generator_target === 'undefined') return;
		// Insert into default content editor
		// else if (window.su_generator_target === 'content') window.mn.media.editor.insert(shortcode);
		// Insert into ET page builder (text box)
		// else if (window.su_generator_target === 'et_pb_content_new') window.mn.media.editor.insert(shortcode);
